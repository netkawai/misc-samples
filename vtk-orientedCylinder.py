...
def drawSurvey(renderer):
    # Create an arrow.
    arrowSource = vtk.vtkArrowSource()

    # Generate a random start and end point
    startPoint = [787301.602,344699.271,5347.061]
    endPoint = [787301.384,344699.098,5345.08]
...
def drawPlan(renderer):
    ...
    # Generate a random start and end point
    startPoint = [787301.363377574,344699.052105782,5347.06317472466]
    endPoint = [787295.548184459,344693.72591688,5311.37675920046]
